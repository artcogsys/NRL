# NRL
Neural Reinforcement Learning Framework

This framework can be used to teach neural networks to solve cognitive tasks. It also provides functionality to interpret
the trained models and link them to observational data.
